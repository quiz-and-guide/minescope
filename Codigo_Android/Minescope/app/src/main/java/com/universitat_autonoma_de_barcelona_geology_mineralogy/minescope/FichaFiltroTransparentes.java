...
public class FichaFiltroTransparentes extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ficha_filtro_transparentes);
        ...
        ArrayList<String> propiedades = myDb.getPropiedadesTransparentesFiltro(id);

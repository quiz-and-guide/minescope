...
public class FichaTransparentes extends AppCompatActivity {
    private ImageView platina1,platina2,platina3,platina4;
    private  String id;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ficha_transparentes);
        ...
        ArrayList<String> propiedades = myDb.getGeneralesTransparentes(id);
        Log.i("id",id);
        ...
        TextView text26 = findViewById(R.id.tv26);
        TextView text27 = findViewById(R.id.tv27);
        ...
        text23.setText(propiedades.get(12));
        text25.setText(propiedades.get(13));
        text27.setText(propiedades.get(14));
        ...
        String fotoLast = myDb.getFotoFromMineralTransparents(id);
        ...
        if (theme.equals("light")) {
            ...
            text26.setTextColor(getResources().getColor(R.color.black));
            text27.setTextColor(getResources().getColor(R.color.black));
            ...
            text26.setTextColor(getResources().getColor(R.color.white));
            text27.setTextColor(getResources().getColor(R.color.white));
        ...
        switch (numberMinerals) {
            case "1":
                ...
                String description1 = myDb.getDescriptionTransparents(id);
                texto1.setText(description1.toUpperCase());
                String nameImage = myDb.getFotoFromMineralTransparents(id);
                ...
                if (imageExist) {
                    ...
                    String urlParalelos = myDb.getURL1TransparentsFromId(id) + "2.jpg";
            ...
            case "2":
                ...
                String description2 = myDb.getDescriptionTransparents(id);
                texto1.setText(description2.toUpperCase());
                String description3 = myDb.getDescriptionTransparents(String.valueOf(Integer.parseInt(id)-1));
                texto2.setText(description3.toUpperCase());
                String nameImage1 = myDb.getFotoFromMineralTransparents(id);
                ...
                if (imageExist1) {
                    ...
                    String urlParalelos1=myDb.getURL1TransparentsFromId(id) + "2.jpg";
                    Picasso.get().load(urlParalelos1).into(platina1);
                }
                String nameImage2 = myDb.getFotoFromMineralTransparents(String.valueOf(Integer.parseInt(id)-1));
                ...
                if (imageExist2) {
                    ...
                    String urlParalelos2=myDb.getURL1TransparentsFromId(String.valueOf(Integer.parseInt(id) - 1)) + "2.jpg";
            ...
            case "4":
                ...
                String description4 = myDb.getDescriptionTransparents(id);
                texto1.setText(description4.toUpperCase());
                String description5 = myDb.getDescriptionTransparents(String.valueOf(Integer.parseInt(id)-1));
                texto2.setText(description5.toUpperCase());
                String description6 = myDb.getDescriptionTransparents(String.valueOf(Integer.parseInt(id)-2));
                texto3.setText(description6.toUpperCase());
                String description7 = myDb.getDescriptionTransparents(String.valueOf(Integer.parseInt(id)-3));
                texto4.setText(description7.toUpperCase());
                String nameImage3 = myDb.getFotoFromMineralTransparents(id);
                ...
                if (imageExist3) {
                    ...
                    String urlParalelos3=myDb.getURL1TransparentsFromId(id) + "2.jpg";
                    Picasso.get().load(urlParalelos3).into(platina1);
                }
                int id4 = Integer.parseInt(id)-1;
                String nameImage4 = myDb.getFotoFromMineralTransparents(String.valueOf(id4));
                ...
                if (imageExist4) {
                    ...
                    String urlParalelos3=myDb.getURL1TransparentsFromId(String.valueOf(id4)) + "2.jpg";
                    Picasso.get().load(urlParalelos3).into(platina2);
                }
                int id5 = Integer.parseInt(id)-2;
                String nameImage5 = myDb.getFotoFromMineralTransparents(String.valueOf(id5));
                ...
                if (imageExist5) {
                    ...
                    String urlParalelos5=myDb.getURL1TransparentsFromId(String.valueOf(id5)) + "2.jpg";
                    Picasso.get().load(urlParalelos5).into(platina3);
                }
                int id6 = Integer.parseInt(id)-3;
                String nameImage6 = myDb.getFotoFromMineralTransparents(String.valueOf(id6));
                ...
                if (imageExist6) {
                    ...
                    String urlParalelos6=myDb.getURL1TransparentsFromId(String.valueOf(id6)) + "2.jpg";
            ...
            case "2":
                switch (sizeText) {
                    case "+2":
                        ...
                        text26.setTextSize(34);
                        text27.setTextSize(34);
                    ...
                    case "+1":
                        ...
                        text26.setTextSize(32);
                        text27.setTextSize(32);
                    ...
                    case "0":
                        ...
                        text26.setTextSize(30);
                        text27.setTextSize(30);
                    ...
                    case "-1":
                        ...
                        text26.setTextSize(28);
                        text27.setTextSize(28);
                    ...
                    case "-2":
                        ...
                        text26.setTextSize(26);
                        text27.setTextSize(26);
            ...
            case "1":
                switch (sizeText) {
                    ...
                    case "0":
                        ...
                        text26.setTextSize(24);
                        text27.setTextSize(24);
                    ...
                    case "-1":
                        ...
                        text26.setTextSize(22);
                        text27.setTextSize(22);
            ...
            case "0":
                switch (sizeText) {
                    ...
                    case "-1":
                        ...
                        text26.setTextSize(16);
                        text27.setTextSize(16);
                    ...
                    case "-2":
                        ...
                        text26.setTextSize(14);
                        text27.setTextSize(14);
        ...
        button1.setOnClickListener(view -> {
            Intent intent1 = new Intent(FichaTransparentes.this, MicroscopioTransparentes.class);
        ...
        rg1.setOnCheckedChangeListener((group, checkedId) -> {
            if (checkedId==R.id.radioParalelos1) {
                ...
                String completImageName1 = myDb2.getFotoFromMineralTransparents(id) + "a-1.jpg";
                boolean imageExist1 = imageExists(completImageName1);
                if (imageExist1) {
                    loadImageFromInternalStorage(completImageName1, platina1);
                } else {
                    String urlParalelos=myDb2.getURL1TransparentsFromId(id) + "2.jpg";
                    Picasso.get().load(urlParalelos).into(platina1);
                }
                myDb2.closeDatabase();
            } else {
                Database myDb3 = new Database(this);
                String completImageName2 = myDb3.getFotoFromMineralTransparents(id) + "b-1.jpg";
                boolean imageExist2 = imageExists(completImageName2);
                if (imageExist2) {
                    loadImageFromInternalStorage(completImageName2,platina1);
                } else {
                    String urlCruzados=myDb3.getURL2TransparentsFromId(id) + "2.jpg";
        ...
        rg2.setOnCheckedChangeListener((group, checkedId) -> {
            if (checkedId==R.id.radioParalelos2) {
                Database myDb2 = new Database(this);
                String completImageName1 = myDb2.getFotoFromMineralTransparents(String.valueOf(Integer.parseInt(id) - 1)) + "a-1.jpg";
                boolean imageExist1 = imageExists(completImageName1);
                if (imageExist1) {
                    loadImageFromInternalStorage(completImageName1, platina2);
                } else {
                    String urlParalelos=myDb2.getURL1TransparentsFromId(String.valueOf(Integer.parseInt(id) - 1)) + "2.jpg";
                    Picasso.get().load(urlParalelos).into(platina2);
                }
                myDb2.closeDatabase();
            } else {
                Database myDb3 = new Database(this);
                String completImageName2 = myDb3.getFotoFromMineralTransparents(String.valueOf(Integer.parseInt(id)-1)) + "b-1.jpg";
                boolean imageExist2 = imageExists(completImageName2);
                if (imageExist2) {
                    loadImageFromInternalStorage(completImageName2,platina2);
                } else {
                    String urlCruzados=myDb3.getURL2TransparentsFromId(String.valueOf(Integer.parseInt(id) - 1)) + "2.jpg";
        ...
        rg3.setOnCheckedChangeListener((group, checkedId) -> {
            if (checkedId==R.id.radioParalelos3) {
                Database myDb2 = new Database(this);
                String completImageName1 = myDb2.getFotoFromMineralTransparents(String.valueOf(Integer.parseInt(id) - 2)) + "a-1.jpg";
                boolean imageExist1 = imageExists(completImageName1);
                if (imageExist1) {
                    loadImageFromInternalStorage(completImageName1, platina3);
                } else {
                    String urlParalelos=myDb2.getURL1TransparentsFromId(String.valueOf(Integer.parseInt(id) - 2)) + "2.jpg";
                    Picasso.get().load(urlParalelos).into(platina3);
                }
                myDb2.closeDatabase();
            } else {
                Database myDb3 = new Database(this);
                String completImageName2 = myDb3.getFotoFromMineralTransparents(String.valueOf(Integer.parseInt(id)-2)) + "b-1.jpg";
                boolean imageExist2 = imageExists(completImageName2);
                if (imageExist2) {
                    loadImageFromInternalStorage(completImageName2,platina3);
                } else {
                    String urlCruzados=myDb3.getURL2TransparentsFromId(String.valueOf(Integer.parseInt(id) - 2)) + "2.jpg";
        ...
        rg4.setOnCheckedChangeListener((group, checkedId) -> {
            if (checkedId==R.id.radioParalelos4) {
                Database myDb2 = new Database(this);
                String completImageName1 = myDb2.getFotoFromMineralTransparents(String.valueOf(Integer.parseInt(id) - 3)) + "a-1.jpg";
                boolean imageExist1 = imageExists(completImageName1);
                if (imageExist1) {
                    loadImageFromInternalStorage(completImageName1, platina3);
                } else {
                    String urlParalelos=myDb2.getURL1TransparentsFromId(String.valueOf(Integer.parseInt(id) - 3)) + "2.jpg";
                    Picasso.get().load(urlParalelos).into(platina4);
                }
                myDb2.closeDatabase();
            } else {
                Database myDb3 = new Database(this);
                String completImageName2 = myDb3.getFotoFromMineralTransparents(String.valueOf(Integer.parseInt(id)-3)) + "b-1.jpg";
                boolean imageExist2 = imageExists(completImageName2);
                if (imageExist2) {
                    loadImageFromInternalStorage(completImageName2,platina4);
                } else {
                    String urlCruzados=myDb3.getURL2TransparentsFromId(String.valueOf(Integer.parseInt(id) - 3)) + "2.jpg";
